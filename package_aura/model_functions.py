'''
This file includes all train, predict, and evaluate functions for the models:
1. train_linreg_model: trains a linear regression model with synthetic data and uploads it to GCS
2. train_gradient_boosting_model: trains a gradient boosting model with synthetic data and uploads it to GCS
3.model_predict: loads a given model from GCS and uses it to make a prediction
4. model_evaluate: loads a given model and evaluates it
'''
